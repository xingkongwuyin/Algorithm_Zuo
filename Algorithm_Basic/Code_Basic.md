...
1. **==背包问题==**
   ...
   * Code
     ...
     public class Code01_Knapsack {
         ...
         // 当前考虑到了index货物，index之后的货物可以自由选择
         // 做的选择不能超过背包的最大容量
         // 返回最大价值
     	// index 0~N
     	// rest 负~bag
     	public static int process(int[] w, int[] v, int index, int rest) {
             // rest == 0时，w[index]和后面的可能等于0
     		if (rest < 0) {
     			return -1;
     		}
     		if (index == w.length) {
...
1. **==最长回文子序列==**
   ...
   * **Question**
     ...
     ![](https://dawn1314.oss-cn-beijing.aliyuncs.com/typora202207220818064.png)
   ...
   * Code
     ...
     * 题解
       ...
       + ![](https://dawn1314.oss-cn-beijing.aliyuncs.com/typora202207220834743.png)
       + ![image-20220722085001794](https://dawn1314.oss-cn-beijing.aliyuncs.com/typora202207220850894.png)
       + ![image-20220722091758571](https://dawn1314.oss-cn-beijing.aliyuncs.com/typora202207220917656.png)
       + ![image-20220722093231795](https://dawn1314.oss-cn-beijing.aliyuncs.com/typora202207220932863.png)

       * 范围讨论模型特别注意：开头和结尾的可能性，而样本讨论模型特备注意两个样本的结尾的可能性
       * 写出严格的位置依赖可能能优化很多，就像这个题不用去比左下的值，优化了一个常数时间
...
4. **==货币问题3==**
   ...
   + Question
     ...
     + ![image-20220726070934974](https://dawn1314.oss-cn-beijing.aliyuncs.com/typora202207261147228.png)
     + 相当与货币问题2中，将所有的货币放在同一个数组

   + Code

     + ![image-20220726072721113](https://dawn1314.oss-cn-beijing.aliyuncs.com/typora202207261147293.png)

       ![image-20220726073330497](https://dawn1314.oss-cn-beijing.aliyuncs.com/typora202207261147275.png)
...
5. **==醉汉问题==**
   ...
   + Question
     ...
     ![image-20220727153438630](https://dawn1314.oss-cn-beijing.aliyuncs.com/typora202207271534710.png)
   ...
   * Code
     ...
     + ```java
       ...
       public class Code05_BobDie {
           ...
           // 4 ^ k 是假设区域无限大，所有的生存点（里面有重复的，process求出来也有重复的）
